...
?>
    ...
    <body>
        ...
        <!-- Descripción del archivo. Página secundaria de los usuarios profesor. Aquí se realizan los premios a los alumnos --> 
            ...
            <div class="main">
                ...
                <div class="info">
                    ...
                    ?>
                       ...
                       <!-- Segundo formulario con los alumnos del curso seleccionado y las normas que suman puntos de ese curso. -->
                       
                        <div class="second_info">
                            <form action="back_reward.php" method="post">
                                <div class="line">
                        ...
                        $reasons = "SELECT Id_motivo, Motivo from perdida_ganancia where Codigo_curso = '" . $grade . "' and Puntuacion not like '-%' order by Puntuacion";
